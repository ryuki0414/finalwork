...
function db_conn()
{
  try {
    ...
    if ($_SERVER["HTTP_HOST"] != 'localhost') {
      $db_name = "ryuki0414_gs_dbx";  //データベース名
...
//     $pdo = new PDO('mysql:dbname=ryuki0414_gs_dbx;charset=utf8;host=mysql57.ryuki0414.sakura.ne.jp', 'ryuki0414', 'ryuki0414_');
